<template>
  <div class="container" v-loading="loading" element-loading-text="加载中" element-loading-spinner="el-icon-loading">
    <div class="head">
      ...
      <el-tab-pane label="车位卡信息" name="first">
        <div class="content">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8" v-show="parkingCardInfo.cardType === 1"><span>车位号：</span>{{parkingCardInfo.parkingNumber}}</el-col>
          </el-row>
          <!-- <el-row :gutter="20">
            ...
            >
              ...
              <el-table-column fixed="right" label="操作" align="center" width="180">
                <template slot-scope="scope">
                  <el-button type="text" style="fon" size="small" @click="detail(scope.row)">详情</el-button>
                </template>
              </el-table-column>
            </el-table>
            <el-pagination
...
export default {
  ...
  methods: {
    ...
    detail(row) {
      this.$router.push({ path: '/operationsManage/parking-record/detail', query: { orderId: row.orderId, activeName: this.activeName } })
    }
  }
}
</script>
